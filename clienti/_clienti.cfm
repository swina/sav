...
<table style="width:100%;height:94%;margin:0;">
	<tr>
		<td valign="top">
		<div class="container">
		<div id="statusBar" class="winblue" style="width:100%;height:25px"><div class="winhead"><strong>Contatti</strong>&nbsp;<img src="../include/css/icons/altre/001_01.png" align="absmiddle" style="cursor:pointer" alt="Aggiungi Contatto" title="Aggiungi Contatto" onclick="addAnagrafica()"><cfif session.livello LT 2>&nbsp;<img src="../include/css/icons/altre/001_02.png" align="absmiddle" style="cursor:pointer" alt="Elimina Contatto" title="Elmina Contatto" onclick="deleteAnagrafica()">
		<cfif nrNuoviContatti GT 0>
			[<strong><cfoutput>#nrNuoviContatti# nuovi contatti importati</cfoutput></strong>] 
		</cfif>
		<input type="button" class="btn" value="Vedi Importati" onclick="vediNuoviContatti()"> 
		<input type="button" class="btn" value="Vedi Contatti" onclick="reloadClienti()">
		<input type="button" class="btn" value="Importa" onclick="importaClienti()">
		
	</cfif>
	<input type="button" class="btn" value="Excel" onclick="printClienti()" title="Esporta in Excel"></div></div>
...
<cfif remote_addr NEQ "89.118.53.254">
	<cfinclude template="_clientiForm.cfm">
<cfelse>
	<cfinclude template="_clientiFormIstat.cfm">
</cfif>
</div>
