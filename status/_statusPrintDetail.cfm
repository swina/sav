...
ORDER BY dt_status DESC) AS myresult 
...
<cfoutput>
<strong>STATUS CONTATTI</strong> #DateFormat(now(),"dd.mm.yyyy")#<br>

<strong>AGENTE : #StructFind(session.userlogin,"utente")#</strong><br>
<br>

<strong>CLIENTE:</strong> <br>
#UCASE(rsAll.ac_cognome)# #UCASE(rsAll.ac_nome)#<br>
#rsAll.ac_indirizzo# #rsAll.ac_citta#<br>
#rsAll.ac_email#<br>
#rsAll.ac_telefono#<br>
#rsAll.ac_cellulare# <br>
<br>
