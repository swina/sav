...
<div class="winblue">
<div id="left" class="winblue" style="margin-right:5px">
	<div id="searchHeader" class="winblue" style="margin-right:10px"><cfinclude template="_statusFilter.cfm"></div>
	<div id="gridboxSTATUS" style="margin:10px;width:90%;height:90%;overflow:auto"></div>
</div>
