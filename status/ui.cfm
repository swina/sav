...
<div id="left" class="winblue">
	<div id="searchHeader" class="winblue" style="margin:0;padding:0;"><cfinclude template="_statusFilter.cfm"></div>
	<div id="gridboxSTATUS" style="height:90%;overflow:auto;"></div>
</div>
