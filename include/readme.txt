dhtmlxSuite 2010 Rel.1 (DHTMLX 2.6)  Standard edition build 100916 (with IE9 beta fix applied) + dhtmlxChart 2.6.5
...
More details about usage of libCompiler can be found here: https://www.dhtmlx.com/docs/products/docsExplorer/index.shtml?node=libc_
