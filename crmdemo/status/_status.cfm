...
<cfparam name="url.start" default=0>
 <!--- COLONNA SX --->
<div class="container" style="height:83%;width:98%;border:1 solid red">
<table style="width:900px;height:92%;margin-bottom:10px;overflow:auto" border="0">
<tr>
	...
	<!--- ricerca cliente --->
	<div id="searchHeader" class="winblue" style="width:600px;margin:0;padding:0"><cfinclude template="_statusFilter.cfm">
	<!--- grid status --->
	</div><div id="gridboxSTATUS" style="width:100%;height:600px;overflow:auto"></div>
...
<!--- COLONNA DX --->
<td valign="top" style="height:90%;width:250px;padding-right:10px" class="winblue">
		<div id="subView" class="container" style="padding-right:10px;width:250px;height:95%;display:;overflow:auto">
		...
		<div id="gridboxCLIENTE" style="height:250px;display:;"></div>
	 </div>
