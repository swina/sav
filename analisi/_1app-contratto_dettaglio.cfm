...
<cfif month(now()) LT 4>
	<cfset anno = year(now())-1>
	<cfset mese = month(now()) + 9>
	<cfset giorno = day(now())>
	<cfparam name = "from" default="#CreateDate(anno,mese,giorno)#">
<cfelse>
...
<cfset totali = 0>
<cfset thisAgente = 0>
<cfset myHTML = "<tr bgcolor='##eaeaea'><td></td><td><strong>GRUPPO</strong></td><td><strong>AGENTE</strong></td><td><strong>CLIENTE</strong></td><td><strong>CONTATTO PROPRIO/SEDE</strong></td><td><strong>DATA</strong></td><td><strong>GG.</strong></td></tr>">
...
<cfoutput query="getContratti">
	...
	<cfloop query="getStatus">
		...
		<cfif getStatus.id_processo EQ 3>
			<cfset myData = getStatus.dt_status>
		</cfif>
...
<cfoutput>
<table width="100%" id="myDetail" cellpadding="3" cellspacing="0" style="display:">
<!--- 	<tr bgcolor="##eaeaea">
