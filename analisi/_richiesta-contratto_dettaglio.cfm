...
<cfif id_agente NEQ "">
	<cfif ListLen(id_agente) GT 1>
		...
		AND id_persona IN ( #id_agente# )
	<cfelse>
		AND id_persona = #id_agente#		
	</cfif>
</cfif>
</cfquery>
<style>
...
<table width="100%" cellspacing="0" cellpadding="2" style="border:1px solid #eaeaea">
	<tr>
		<td colspan="8">
		<strong>ANALISI RICHIESTA OFFERTA - CONTRATTO </strong> Periodo : <cfoutput><strong>#url.dateFrom# - #url.DateTo#</strong>
	...
	<tr bgcolor="#eaeaea">
		<td>RICHIESTA DI OFFERTA - CONTRATTO</td>
		<td></td>
		<td>CONTRATTO senza richiesta di offerta</td>
		<td></td>
