...
function createExcelThis(params){
	document.getElementById("excel_detail").src = "_assegnazioniXLS.cfm?mode=apps&"+ params;
}
</script>
...
<table width="50%" cellspacing="0" cellpadding="2" style="border:1px solid #eaeaea">
	<tr>
		...
		<strong>ASSEGNAZIONI </strong> Periodo : <cfoutput><strong>#DateFormat(from,"dd/mm/yyyy")# - #DateFormat(to,"dd/mm/yyyy")#</strong>
		...
		<cfset thisHTML = "#thisHTML#<tr><td><strong>AGENTE</strong></td><td><strong>ASSEGNAZIONI</strong></td><td><strong>CONTESTATI</strong></td><td><strong>FORNITORI</strong></td><td><strong>CLIENTE SAV</strong></td><strong></strong><td><strong>TOTALE</strong></td></tr>">

	</tr>
	<tr>
		<td><strong>AGENTE</strong></td>
		<td><strong>ASSEGNAZIONI</strong></td>
		<td><strong>CONTESTATI</strong></td>
		<td><strong>%</strong></td>
	...
	<tr>
		...
		<cfinvoke component="statistiche" method="findStatus" returnvariable="contestato">
			...
			<cfinvokeargument name="lista_clienti" value="#Left(lista_clienti,Len(lista_clienti)-1)#">
...
<table width="50%" cellspacing="0" cellpadding="2" style="border:1px solid #eaeaea">
	<tr>
		<td colspan="8" class="winblue">
		<cfset thisHTML = "#thisHTML#<tr><td colspan='6'><strong>ASSEGNAZIONI </strong>Periodo : <cfoutput><strong>#DateFormat(from,'dd/mm/yyyy')# - #DateFormat(to,'dd/mm/yyyy')#</strong></td></tr>">	
		<strong>ASSEGNAZIONI </strong> Periodo : <cfoutput><strong><strong>#DateFormat(from,"dd/mm/yyyy")# - #DateFormat(to,"dd/mm/yyyy")#</strong>
		...
		<cfset thisHTML = "#thisHTML#<tr><td><strong>AGENTE</strong></td><td><strong>ASSEGNAZIONI</strong></td><td><strong>CONTESTATI</strong></td><td><strong>FORNITORI</strong></td><td><strong>CLIENTE SAV</strong></td><td><strong>TOTALE</strong></td></tr>">
		</td>
	</tr>
	<tr>
		<td><strong>AGENTE</strong></td>
