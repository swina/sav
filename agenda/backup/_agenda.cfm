...
<div style="float:left"><strong>Agenda</strong> &nbsp;</div><cfinclude template="_agendaFilter.cfm">
 </div>
...
scheduler.templates.event_text=function(start,end,event){
   return "<b> "+event.text+"</b><br>"+event.details+event.id;
  }
  
scheduler.load("_agendaXML.cfm");
scheduler.attachEvent("onXLE", doAgendaLoaded);
//scheduler.attachEvent("onAfterLightbox", doOpenStatus );
